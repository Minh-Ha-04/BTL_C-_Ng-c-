...
module.exports = {
  up: async (queryInterface, Sequelize) => {
        ...
        [
          {
            category: "biển",
            description:
              "Tour du lịch biển, đảo với bãi cát trắng và nước trong xanh",
            created_at: now,
            updated_at: now,
          },
          {
            category: "núi",
            description:
              "Tour leo núi, trekking, khám phá thiên nhiên hoang dã",
            created_at: now,
            updated_at: now,
          },
          {
            category: "thành phố",
            description: "Tour khám phá thành phố, văn hóa, ẩm thực đặc sắc",
            created_at: now,
            updated_at: now,
          },
          {
            category: "trekking",
            description: "Tour đi bộ đường dài, khám phá thiên nhiên",
            created_at: now,
            updated_at: now,
          },
          {
            category: "văn hóa",
            description: "Tour văn hóa - lịch sử, khám phá di sản",
            created_at: now,
            updated_at: now,
          },
        ],
    ...
    // Lấy category IDs
    const [beachCat] = await queryInterface.sequelize.query(
      "SELECT id FROM categories WHERE category = 'biển' LIMIT 1"
    );
    const [mountainCat] = await queryInterface.sequelize.query(
      "SELECT id FROM categories WHERE category = 'núi' LIMIT 1"
    );
    const [cityCat] = await queryInterface.sequelize.query(
      "SELECT id FROM categories WHERE category = 'thành phố' LIMIT 1"
    );
    const [hikingCat] = await queryInterface.sequelize.query(
      "SELECT id FROM categories WHERE category = 'trekking' LIMIT 1"
    );
    const [culturalCat] = await queryInterface.sequelize.query(
      "SELECT id FROM categories WHERE category = 'văn hóa' LIMIT 1"
    );
    ...
    const toursSeedData = [
      {
        ...
        description:
          "Khám phá thành phố Đà Lạt xinh đẹp với khí hậu mát mẻ quanh năm. Tham quan thác Datanla, hồ Xuân Hương, Thiền viện Trúc Lâm, Crazy House. Thưởng thức đặc sản địa phương như lẩu gà lá é, bánh tráng nướng. Check-in tại các điểm sống ảo hot nhất Đà Lạt.",
        region: "central",
      ...
      },
      {
        ...
        description:
          "Tận hưởng bãi biển đẹp nhất Việt Nam với cát trắng mịn và nước biển trong xanh. Tham quan Vinpearl Land, đảo Hòn Mun, Hòn Tằm, Hòn Miễu. Lặn ngắm san hô, thưởng thức hải sản tươi ngon. Vui chơi tại công viên nước hiện đại.",
        region: "southern",
      ...
      },
      {
        ...
        description:
          "Du thuyền sang trọng trên vịnh Hạ Long với hơn 1600 hòn đảo lớn nhỏ. Tham quan hang Sửng Sốt, hang Thiên Cung, đảo Titop, làng chài Cửa Vạn. Thưởng thức buffet hải sản tươi sống. Ngắm hoàng hôn và bình minh tuyệt đẹp trên vịnh.",
        region: "northern",
        category_id: beachCat[0]?.id || 1,
      ...
      },
      {
        ...
        description:
          "Chinh phục đỉnh Fansipan - nóc nhà Đông Dương với cáp treo hiện đại. Tham quan bản Cát Cát, thác Tình Yêu, nhà thờ đá. Trải nghiệm văn hóa dân tộc vùng cao. Thưởng thức thắng cố đặc sắc.",
        region: "northern",
      ...
      },
      {
        ...
        description:
          "Khám phá hòn đảo lớn nhất Việt Nam với bãi biển đẹp nhất hành tinh. Tham quan Vinpearl Safari, Công viên chủ đề, làng chài Hàm Ninh. Lặn biển ngắm san hô, thưởng thức hải sản. Vui chơi resort 5 sao.",
        region: "southern",
        category_id: beachCat[0]?.id || 1,
      ...
      },
      {
        ...
        description:
          "Khám phá phố cổ Hội An - di sản văn hóa thế giới UNESCO. Tham quan Chùa Cầu, Nhà Cổ Phùng Hưng, Hội Quán Phúc Kiến. Trải nghiệm làm đèn lồng, học nấu ăn. Vui chơi bãi biển An Bàng.",
        region: "central",
      ...
      },
      {
        ...
        description:
          "Khám phá cố đô Huế với các di tích lịch sử. Tham quan Đại Nội, Lăng Tự Đức, Chùa Thiên Mụ. Du thuyền trên sông Hương, thưởng thức ẩm thực cung đình. Trải nghiệm văn hóa cung đình Việt Nam.",
        region: "central",
        category_id: culturalCat[0]?.id || 5,
      ...
      },
      {
        ...
        description:
          "Khám phá thành phố Đà Nẵng hiện đại và phát triển. Tham quan Bà Nà Hills, Cầu Vàng, Ngũ Hành Sơn, Chùa Linh Ứng. Thưởng thức hải sản tươi ngon, mua sắm tại chợ Hàn.",
        region: "central",
        category_id: cityCat[0]?.id || 3,
        destination: "Đà Nẵng",
        departure: "Hà Nội",
      ...
      },
      {
        ...
        description:
          "Khám phá vùng đất Miền Tây với vườn cây ăn trái. Tham quan Cồn Thới, vườn nhãn, nhà vườn. Thưởng thức trái cây tươi ngon, thưởng thức đờn ca tài tử. Trải nghiệm sông nước miền Tây.",
        region: "southern",
        category_id: cityCat[0]?.id || 3,
      ...
      },
      {
        ...
        description:
          "Khám phá vùng Tây Nguyên với cao nguyên xanh mát. Tham quan Buôn Ma Thuột, Pleiku, Kon Tum. Trải nghiệm văn hóa dân tộc Ê Đê, Gia Rai. Thưởng thức cà phê đặc sản.",
        region: "central",
        category_id: cityCat[0]?.id || 3,
      ...
      },
      {
        ...
        description:
          "Khám phá Cần Thơ - Tây Đô với chợ nổi, vườn cây ăn trái. Tham quan Lò Heo, Chợ Bến Ninh, Cồn Sơn. Thưởng thức trái cây, thưởng thức đờn ca tài tử.",
        region: "southern",
        category_id: cityCat[0]?.id || 3,
        destination: "Cần Thơ",
        departure: "TP. Hồ Chí Minh",
      ...
      },
      {
        ...
        description:
          "Chinh phục các đỉnh núi cao với trekking chuyên nghiệp. Tham quan Thác Bạc, Cổng Trời, bản Lao Chải. Trải nghiệm homestay với đồng bào dân tộc. Thưởng thức thắng cố vùng cao.",
        region: "northern",
      ...
      },
      {
        ...
        description:
          "Khám phá quần đảo Côn Đảo với nhà tù lịch sử. Tham quan Nghĩa Trang Hàng Dương, Nhà Tù Côn Đảo, Bãi Đầm Trầu. Lặn biển ngắm san hô, thưởng thức hải sản.",
        region: "southern",
        category_id: culturalCat[0]?.id || 5,
      ...
      },
      {
        ...
        description:
          "Trải nghiệm Festival đèn lồng Hoi An đầy màu sắc. Tham quan phố cổ về đêm, chợ đêm, cầu Nhật. Tham gia lễ hội, thưởng thức ẩm thực đường phố. Vui chơi bãi biển.",
        region: "central",
        category_id: culturalCat[0]?.id || 5,
        destination: "Hội An, Quảng Nam",
        departure: "Đà Nẵng",
      ...
      },
      {
        ...
        description:
          "Chinh phục đỉnh Fansipan với cáp treo và trekking. Thăm vườn quốc gia Hoàng Liên, thác Tả Van. Trải nghiệm homestay, thưởng thức ẩm thực vùng cao.",
        region: "northern",
        category_id: mountainCat[0]?.id || 2,
      ...
      },
      {
        ...
        description:
          "Khám phá đảo Ngọc Phú Quốc với bãi biển hoang sơ tuyệt đẹp. Tham quan VinWonders, Safari, Grand World, Sunset Sanato. Lặn ngắm san hô ở Hòn Thơm, Hòn Móng Tay. Thưởng thức ẩm thực biển phong phú và ghẹ Hàm Ninh nổi tiếng.",
        region: "southern",
        category_id: beachCat[0]?.id || 1,
        destination: "Phú Quốc, Kiên Giang",
        departure: "TP. Hồ Chí Minh",
      ...
      },
      {
        ...
        description:
          "Chinh phục đỉnh Fansipan - nóc nhà Đông Dương bằng cáp treo hiện đại. Tham quan bản Cát Cát, Thác Bạc, Y Tý với ruộng bậc thang tuyệt đẹp. Khám phá văn hóa dân tộc H'Mông, Dao đỏ. Thưởng thức đặc sản thang cô, cá hồi.",
        region: "northern",
        category_id: mountainCat[0]?.id || 2,
        destination: "Sapa, Lào Cai",
        departure: "Hà Nội",
      ...
      },
      {
        ...
        description:
          "Khám phá thành phố đáng sống Đà Nẵng với cầu Vàng nổi tiếng, bán đảo Sơn Trà, chùa Linh Ứng. Tham quan phố cổ Hội An - Di sản văn hóa thế giới, thả đèn hoa đăng trên sông Hoài. Tắm biển Mỹ Khê, thưởng thức mì Quảng, cao lầu.",
        region: "central",
        category_id: culturalCat[0]?.id || 5,
      ...
      },
      {
        ...
        description:
          "Khám phá kinh đô Huế với Đại Nội, lăng Khải Định, lăng Tự Đức, chùa Thiên Mụ. Du thuyền sông Hương thưởng thức ca Huế. Thưởng thức ẩm thực cung đình: bún bò Huế, cơm hến, bánh bèo, bánh nậm. Tìm hiểu lịch sử triều Nguyễn.",
        category_id: culturalCat[0]?.id || 5,
        destination: "Huế, Thừa Thiên Huế",
        departure: "Đà Nẵng",
        start_date: "2027-01-20",
      ...
      },
      {
        ...
        description:
          "Khám phá Tràng An - Di sản thế giới với hệ thống hang động kỳ vĩ. Đi thuyền qua 9 hang động, chiêm ngưỡng cảnh sắc hùng vĩ. Tham quan chùa Bái Đính, Tam Cốc - Bích Động, động Phượng Hoàng. Leo đỉnh Hang Múa ngắm toàn cảnh.",
        category_id: hikingCat[0]?.id || 4,
      ...
      },
      {
        ...
        description:
          "Khám phá cao nguyên đá Đồng Văn - Công viên địa chất toàn cầu. Chinh phục đèo Mã Pì Lèng, cột cờ Lũng Cú. Tham quan dinh thự Vương, chợ tình Khâu Vai. Thưởng thức đặc sản thắng cố, men mén, rượu ngô.",
        category_id: mountainCat[0]?.id || 2,
      ...
      },
      {
        ...
        description:
          "Khám phá quần đảo Côn Đảo với bãi biển hoang sơ tuyệt đẹp. Tham quan nhà tù Côn Đảo, nghĩa trang Hàng Dương. Lặn ngắm san hô, thả rùa biển. Thưởng thức hải sản tươi sống. Trải nghiệm không gian yên bình, thiêng liêng.",
        category_id: beachCat[0]?.id || 1,
        destination: "Côn Đảo, Bà Rịa - Vũng Tàu",
        departure: "TP. Hồ Chí Minh",
        start_date: "2027-02-05",
      ...
      },
      {
        ...
        description:
          "Chiêm ngưỡng ruộng bậc thang đẹp nhất Việt Nam trong mùa lúa chín. Tham quan bản Lao Chải, bản Tú Lệ với thung lũng nương tuyệt đẹp. Khám phá văn hóa dân tộc Thái, H'Mông. Thưởng thức gạo Tú Lệ nổi tiếng, cơm lam.",
        category_id: mountainCat[0]?.id || 2,
      ...
      },
      {
        ...
        description:
          "Trải nghiệm cuộc sống miệt vườn Nam Bộ. Tham quan chợ nổi Cái Răng, vườn trái cây, làng hoa Sa Đéc. Thưởng thức ẩm thực đặc sản: bánh xèo, lẩu mắm, hủ tiếu. Du thuyền trên sông Hậu, nghe đờn ca tài tử.",
        category_id: culturalCat[0]?.id || 5,
      ...
      },
      {
        ...
        description:
          "Khám phá thành phố biển Quy Nhơn với Eo Gió, Kỳ Co, Hòn Khô. Tham quan tháp Bánh Ít, tháp Đôi Champa cổ kính. Thưởng thức hải sản tươi ngon, bánh xèo tôm nhảy, bánh ít lá gai. Tắm biển, vui chơi tại bãi Xép.",
        category_id: beachCat[0]?.id || 1,
      ...
      },
      {
        ...
        description:
          "Trải nghiệm đồi cát bay Mũi Né với hoạt động trượt cát thú vị. Ngắm bình minh ở đồi cát trắng, hoàng hôn ở đồi cát đỏ. Tham quan suối tiên, rừng dừa Bảy Mẫu. Thưởng thức bánh căn, bánh xèo, hải sản nướng.",
        category_id: beachCat[0]?.id || 1,
      ...
      },
      {
        ...
        description:
          "Khám phá Tây Nguyên với Pleiku, Kon Tum, Buôn Ma Thuột. Tham quan hồ T'Nưng, biển Hồ, thác Dray Nur. Trải nghiệm văn hóa cồng chiêng - Di sản văn hóa phi vật thể. Thưởng thức cà phê Buôn Ma Thuột, rượu cần.",
        category_id: hikingCat[0]?.id || 4,
    ...
    const toursInsertData = toursSeedData.map(
      ({ category_id, ...tour }) => tour
    );
      ...
      2: [
        {
          ...
          detail:
            "Khởi hành từ điểm hẹn. Tham quan các điểm đến chính. Dùng bữa trưa và tối. Nghỉ đêm tại khách sạn.",
        },
        {
          day: 2,
          title: "Ngày 2: Tham quan - Về",
          detail:
            "Ăn sáng tại khách sạn. Tiếp tục tham quan các điểm còn lại. Mua sắm đặc sản. Trở về điểm xuất phát.",
        },
      ],
      3: [
        {
          day: 1,
          title: "Ngày 1: Khởi hành - Check in",
          detail:
            "Khởi hành từ điểm hẹn. Di chuyển đến điểm đến. Check-in khách sạn. Tự do khám phá. Nghỉ đêm.",
        },
        {
          day: 2,
          title: "Ngày 2: Tham quan chính",
          detail:
            "Ăn sáng buffet. Tham quan các điểm đến chính trong ngày. Ăn trưa và tối. Tự do vào buổi tối. Nghỉ đêm.",
        },
        {
          day: 3,
          title: "Ngày 3: Tham quan - Trở về",
          detail:
            "Ăn sáng. Check-out khách sạn. Tham quan các điểm còn lại. Mua sắm quà lưu niệm. Trở về điểm xuất phát.",
        },
      ],
      4: [
        {
          ...
          detail:
            "Khởi hành từ điểm hẹn. Di chuyển đến điểm đến. Nhận phòng khách sạn. Nghỉ ngơi. Tự do khám phá buổi tối.",
        },
        {
          day: 2,
          title: "Ngày 2: Khám phá điểm đến A",
          detail:
            "Ăn sáng. Tham quan điểm đến A với các hoạt động đặc sắc. Ăn trưa tại nhà hàng. Tiếp tục hành trình. Nghỉ đêm.",
        },
        {
          day: 3,
          title: "Ngày 3: Khám phá điểm đến B",
          detail:
            "Ăn sáng. Tham quan điểm đến B. Trải nghiệm các hoạt động thú vị. Ăn trưa và tối. Thời gian tự do. Nghỉ đêm.",
        },
        {
          day: 4,
          title: "Ngày 4: Tham quan - Về",
          detail:
            "Ăn sáng. Check-out. Tham quan điểm cuối. Mua sắm. Trở về điểm xuất phát kết thúc chuyến đi.",
        },
      ],
      5: [
        {
          ...
          title: "Ngày 1: Khởi hành - Check in",
          detail:
            "Khởi hành. Di chuyển đến điểm đến. Check-in khách sạn. Nghỉ ngơi thư giãn.",
        },
        {
          day: 2,
          title: "Ngày 2: Tham quan A",
          detail:
            "Tham quan khu vực A với các điểm nổi bật. Trải nghiệm văn hóa địa phương.",
        },
        {
          day: 3,
          title: "Ngày 3: Tham quan B",
          detail:
            "Khám phá khu vực B. Tham gia các hoạt động đặc sắc. Thưởng thức ẩm thực địa phương.",
        },
        {
          day: 4,
          title: "Ngày 4: Tham quan C",
          detail: "Tham quan khu vực C. Mua sắm quà lưu niệm. Thời gian tự do.",
        },
        {
          day: 5,
          title: "Ngày 5: Tham quan - Trở về",
          detail: "Tham quan điểm cuối. Check-out. Trở về điểm xuất phát.",
        },
      ],
    };
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        {
          code: "TET2027",
          description: "Đón Tết Nguyên Đán - Giảm 15%",
          discount_percent: 15,
          discount_amount: null,
    ...
    if (tourEntries.length > 0) {
      ...
      for (let i = 0; i < 30; i++) {
        ...
        ordersData.push({
          ...
          payment_url: isPaid
            ? `https://payment.example.com/success/${i}`
            : `https://payment.example.com/pending/${i}`,
          is_paid: isPaid,
      ...
      if (order.is_paid) {
        ...
        for (let i = 0; i < order.quantity; i++) {
          ...
          ticketsData.push({
            ...
            ticket_code: `TKT${new Date().getFullYear()}${String(
              new Date().getMonth() + 1
            ).padStart(2, "0")}${String(new Date().getDate()).padStart(
              2,
              "0"
            )}-${String(orderIndex * 10 + i + 1).padStart(4, "0")}`,
            issue_date: now,
